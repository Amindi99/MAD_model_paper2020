package com.example.madmodelpaper.Database;
...
//---- START Define a schema and contract----//
...
//----  END Define a schema and contract----//


//---- START Create a database using an SQL helper-----//
...
//---- END Create a database using an SQL helper-----//


//----START ADD data to database----------//
    // This public void line not in website so we need to type it by own
    public long addInfo(String username, String dob, String password, String gender){
        // If we return value this should be public long, if not public void
...
//----- END DELETE data in database-----//


//----- START READ data in database-----//
        public List readAllInfo(){
            ...
            String sortOrder =
                    UserProfile.Users.COLUMN_1 + " ASC";   // we are going to sort by username
